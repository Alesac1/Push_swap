...
#    Updated: 2023/04/03 15:15:47 by asacchin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC =	srcs/check.c srcs/input.c srcs/push_swap.c Utils/ft_atoi.c Moves/push.c Moves/swap.c Moves/rotate.c Moves/reverse_rotate.c srcs/sorting.c Utils/utils.c
OBJ = ${SRC:.c=.o}
NAME = push_swap

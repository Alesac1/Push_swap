...
#    Updated: 2023/03/27 17:18:58 by asacchin         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC =	srcs/check.c srcs/input.c srcs/push_swap.c Utils/ft_atoi.c Moves/push.c Moves/swap.c Moves/rotate.c Moves/reverse_rotate.c srcs/sorting.c
OBJ = ${SRC:.c=.o}
NAME = push_swap
